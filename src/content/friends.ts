...
export const friends: PageContent = {
  slug: "friends-of-wyman-park-dell",
  title: "Friends of Wyman Park Dell",
  metaDescription:
    "The Friends of Wyman Park Dell is a 501(c)(3) volunteer-run nonprofit dedicated to preserving, protecting, and maintaining Wyman Park Dell.",
  blocks: [
    {
      type: "hero",
      variant: "standard",
    ...
    },
    {
      ...
      width: "medium",
      heading:
        "The Friends of Wyman Park Dell is a 501(c)(3) volunteer-run nonprofit with a mission to preserve, protect, and maintain Wyman Park Dell, an Olmsted legacy park at the intersection of Baltimore’s Charles Village and Remington neighborhoods.",
      align: "center",
      headingColor: "dark",
    },
    {
      ...
      html: `
        <p>Neighbors from Charles Village and Remington established the Friends of Wyman Park Dell (FWPD) in <strong>1983</strong> to stimulate and promote the interest of the public in the preservation, beautification, protection, and maintenance of Wyman Park Dell.</p>
        <p>More than four decades later, the FWPD continues to focus on the Dell’s place within the community, both physically and historically.</p>
    ...
    },
    {
      ...
      members: [
        ...
        {
          name: "Courtney Belew",
          role: "Vice President of Events & Fundraising",
        },
        ...
        {
          name: "Jessica Bell Brown",
          role: "Ex-Officio, Baltimore Museum of Art",
        },
    ...
    },
    {
      ...
      background: "raised",
      html: `
        <p>The FWPD, led by an all-volunteer Board of Directors, engages in the following activities:</p>
        <ul>
          <li><strong>Organizing</strong> regular volunteer clean-ups of the Dell to maintain the existing landscaping, clear out invasive vegetation, and place more suitable plantings to improve the appearance and long-term viability.</li>
          <li><strong>Advocating</strong> for major capital improvements in the Dell, such as restoration of its lower lawn and slopes, improvement to its stormwater drainage, lighting, and electrical systems, repair of its stone walls, stairs, and paths, and installation of a new playground.</li>
          <li><strong>Engaging</strong> with our community through programming that offers everyone from long-time visitors to first-timers a chance to enjoy the Dell through community campouts, movie nights, festivals, concerts and more (like goats!).</li>
          <li><strong>Preserving</strong> the Dell’s historic features and design by using the Wyman Park Dell Master Plan to guide design projects that promote usage of the Dell while honoring its roots as an Olmsted Park.</li>
          <li><strong>Partnering</strong> with local businesses, institutions, and neighbors to ensure that the Dell continues to be a place where community members are able to unwind, relax, commune, and play in a safe and beautiful green environment.</li>
        </ul>
      `,
    },
    {
      ...
      title: "Friends of Wyman Park Dell",
      caption:
        "Watch a short introduction to the Dell and the volunteers who keep it thriving.",
      background: "base",
    },
    {
      type: "projects",
      ...
      projects: [
        ...
        },
        {
          ...
          caption:
            "Narrowed lanes and closed “sweep” along 29th and Howard Streets.",
        },
      ],
    },
    {
